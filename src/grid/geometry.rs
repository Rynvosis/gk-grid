use crate::grid::{Grid, CellOf, CornerOf};
...
pub trait GridGeometry {
    ...
    fn try_cell_corners(&self, cell: impl Into<CellOf<Self::Grid>>) -> Option<impl Iterator<Item=(CornerOf<Self::Grid>, Self::Position)>>;
...
pub trait TotalGridGeometry : GridGeometry {
    ...
    fn cell_corners(&self, cell: impl Into<CellOf<Self::Grid>>) -> impl Iterator<Item=(CornerOf<Self::Grid>, Self::Position)> {
